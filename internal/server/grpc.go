...
func NewGRPCServer(c *conf.Server, thirdModule *thirdmodule.Module, service *service.Service, logger log.Logger) *grpc.Server {
	...
	v1.RegisterServerServer(srv, service)
	return srv
}
