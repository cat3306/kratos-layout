...
func NewHTTPServer(c *conf.Server, thirdModule *thirdmodule.Module, service *service.Service, logger log.Logger) *http.Server {
	...
	v1.RegisterServerHTTPServer(srv, service)
	return srv
}
