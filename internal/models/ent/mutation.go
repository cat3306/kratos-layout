...
func withFooID(id int64) fooOption {
...
func (m *FooMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *FooMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *FooMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
...
// WhereP appends storage-level predicates to the FooMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *FooMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Foo, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *FooMutation) SetOp(op Op) {
	m.op = op
}
