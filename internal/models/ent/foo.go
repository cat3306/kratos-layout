...
// to the Foo fields.
func (_m *Foo) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the Foo.
// This includes values selected through modifiers, order, etc.
func (_m *Foo) Value(name string) (ent.Value, error) {
